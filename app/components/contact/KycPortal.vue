<template>
  <aside
    class="scroll-reveal kyc-panel group relative flex h-full flex-col overflow-hidden
  ...
  >
    ...
    <div class="relative z-10 flex flex-1 flex-col px-7 py-7 sm:px-8">
      ...
      <a
        href="#"
        class="group/button mt-auto inline-flex w-full items-center justify-center
